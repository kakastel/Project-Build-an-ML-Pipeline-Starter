...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--input_artifact", 
        type=str,
        help='Name of the artifact you want cleaned',
        required=True
    )
    ...
    parser.add_argument(
        "--output_artifact", 
        type=str,
        help="The name of the output; the cleaned artifact",
        required=True
    )
    ...
    parser.add_argument(
        "--output_type", 
        type=str,
        help="Type to group the output artifact under",
        required=True
    )
    ...
    parser.add_argument(
        "--output_description", 
        type=str,
        help="The Description stored with the output artifact",
        required=True
    )
    ...
    parser.add_argument(
        "--min_price", 
        type=float,
        help="Input the minimum price you want to consider for Airbnb",
        required=True
    )
    ...
    parser.add_argument(
        "--max_price",
        type=float,
        help="Input the maximum price you want to consider for Airbnb",
        required=True
    )
